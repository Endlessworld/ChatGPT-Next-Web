...
export const DEFAULT_MODELS: readonly LLMModel[] = [
  ...
  },
  {
    ...
    displayName: "llama-3-8b",
    description: "Meta|8K|62.2|代码精通|代码能力超越llama-2-70b",
    available: true,
  },
  {
    name: "meta-llama/Llama-3-70b-chat-hf",
    displayName: "llama-3-70b",
    description: "Meta|8K|81.7|70b模型上限|代码精通|强烈推荐",
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: "Groq|速度x18|SMoE|32k|46.7B|略优于GPT3.5",
    available: true,
  },
  {
    name: "llama2-70b-4096",
    description: "Groq|速度x18",
    available: true,
  },
  {
    name: "mixtral-8x22b-finetuned",
    displayName: "mixtral-8x22b",
    description: "mistralai|最强开源|64k|141B",
    available: true,
  },
  {
    name: "microsoft/WizardLM-2-8x22B",
    displayName: "wizardlm-2-8x22B",
    description: "microsoft|基于mixtral-8x22b微调|响应极慢",
    available: true,
  },
  {
