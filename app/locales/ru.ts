...
const ru: LocaleType = {
  ...
  Error: {
    ...
    HelloMessage: `Добро пожаловать в X-ChatGPT
      Доступен бесплатный канал, который предоставляет вам 15 бесплатных пробных доступов в час / IP.
      Вы можете использовать пароль доступа, чтобы разблокировать до 50 бесплатных доступов в час / IP.
