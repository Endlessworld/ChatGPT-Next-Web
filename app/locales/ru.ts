...
const ru: PartialLocaleType = {
  ...
  Chat: {
    ...
    Actions: {
      ...
      Retry: "Повторить",
      Delete: "Удалить",
      Replace: "Заменить выбранное",
      Merge: "Объединить код",
    },
  ...
  Settings: {
    ...
    User: {
      ...
      SubTitle:
        "Войдите в систему, чтобы синхронизировать информацию о пользователе",
      PointsTitle: "Очки пользователя",
      PointsSubTitle:
        "Очки пользователя сообщества могут быть обменены на использование",
    },
    InjectSystemPrompts: {
  ...
  Replace: {
    Success: "Блок кода заменен/вставлен в редактор",
    Failed: "Не удалось скопировать. Предоставьте доступ к буферу обмена",
  },
  Merge: {
    Success: "Открыто окно объединения кода",
    Failed: "Не удалось открыть окно объединения кода",
  },
  Copy: {
