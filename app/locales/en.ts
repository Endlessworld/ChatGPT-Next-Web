...
const en: PartialLocaleType = {
  ...
  Sidebar: {
    Title: "X-Copilot",
    SubTitle: "Your personal AGI Copilot.",
    Profile: "Profile",
    Announcement: {
      Title: "Announcement",
      Content: ``,
  ...
  Replace: {
    Success: "Code block replaced/inserted into the editor",
    Failed: "Copy failed, please grant clipboard permissions",
  },
  Merge: {
    Success: "Code merge window opened",
    Failed: "Failed to open code merge window",
  },
  Vip: {
    Title: "Paid Plan",
  },
